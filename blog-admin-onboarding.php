    ...
    <section class="parallax effect-section" style="background-color:#0D4963">
        <div class="container position-relative">
            <div class="row min-vh-50 align-items-center justify-content-center pt-8 pb-12">
                <div class="col-lg-8">
                    <h1 class="display-5 text-white m-0 text-center">How to start CodeDoor as an administrator</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <article class="card card-body">
                    <h5>How to start CodeDoor as an administrator</h5>
                    <p>We are very much looking forward to welcoming you to CodeDoor! In case of questions you can contact us via <a href="mailto:hello@codedoor.org">hello@codedoor.org</a>. Please do not hesitate to contact us - we would love to help you!</p>
                    <p>Before you can start using CodeDoor, you need to receive an email invite from with your personal registration invite.</p>
                    <p>If this first message does not reach you, please start by checking your spam filter. If you do not find it there, please reach out to your CodeDoor contact and we will check what happened to your message!</p>
                    <p>This is the first message you receive:</p>

                    <img src="static/img/screenshots/Mail_register.png">
                    <br/>
                    <p>Use the "Register now"-button to register:</p>

                    <p>Register yourself by using your first and last name. Please choose your own password:</p>
                    <img src="static/img/screenshots/Registration.jpeg">

                    <p>After registration, you will reach your personal dashboard on CodeDoor.</p>
                            ...
                            <div class="col-md-6">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ps-3">
                                        <h6 class="mb-1">September 21th 2021, Your CodeDoor Team</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
