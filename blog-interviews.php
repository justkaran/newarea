    ...
    <section class="parallax effect-section" style="background-color:#0D4963">
        <div class="container position-relative">
            <div class="row min-vh-50 align-items-center justify-content-center pt-8 pb-12">
                <div class="col-lg-8">
                    <h1 class="display-5 text-white m-0 text-center">Meet our awesome alumni</h1>
                    <ul class="nav mt-4 justify-content-center">
                        ...
                        <li class="h6 mx-2 text-white font-weight-normal"><i class="far fa-clock me-2"></i> Latest Entry: November 8, 2021</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <article class="card card-body">
                    <p>We asked CodeDoor alumni to share their experiences and give tips to current learners. Here's what they told us:</p>
                    <h5>Casneil</h5>
                    ...
                    <p>I took my first step as a Junior Salesforce Admin. Currently I have three certificates in Salesforce, preparing for more to come. My main goal is to hone my skills in Salesforce Ecosystem.
                    </p>
                            ...
                            <div class="col-md-6">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ps-3">
                                        <h6 class="mb-1">November 8, 2021, Your CodeDoor Team</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
