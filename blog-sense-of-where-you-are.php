    ...
    <section class="parallax effect-section" style="background-color:#0D4963">
        <div class="container position-relative">
            <div class="row min-vh-50 align-items-center justify-content-center pt-8 pb-12">
                <div class="col-lg-8">
                    <h1 class="display-5 text-white m-0 text-center">A sense of where you are</h1>
                    <ul class="nav mt-4 justify-content-center">
                        <li class="h6 mx-2 text-white font-weight-normal"><i class="fas fa-user me-2"></i>Latest Entry by: Karan from the CodeDoor Team</li>
                        <li class="h6 mx-2 text-white font-weight-normal"><i class="far fa-clock me-2"></i> Latest Entry: July 30th 2021</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <article class="card card-body">
                    ...
                    <p>This is based on an article published in the yearly report of <a href="https://enpact.org">enpact.org</a>. One of the greatest startup supporting organizations we partner with. </p>
                    <p>
                            ...
                            <div class="col-md-6">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ps-3">
                                        <h6 class="mb-1">July 30th 2021, Your CodeDoor Team</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
