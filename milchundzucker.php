            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center text-white">
                        <h1>Milch und Zucker Projekt</h1>
                        <div class="lead">Redi School of Digital Integration und CodeDoor machen Dich fit für eine Stelle bei Milch und Zucker </div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
                        <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_y55svid8.json"  background="transparent"  speed="1"  style="width: 500px; height: 500px; padding-left: 100px; padding-bottom: 100px;"  loop  autoplay></lottie-player>
                    </div>
                    <div class="col-lg-6 my-3 ps-lg-8">
                        ...
                        <p class="lead">Die Projekte sind von Milch und Zucker abgesegnet. Wenn Du zeigst, dass Du sie beherrschst, hast Du eine gute Chance auf ein Job Placement.</p>
                            <br>
                            <br>
                            <strong>Die Projektkategorien</strong>
