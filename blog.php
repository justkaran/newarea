...
<body>
    ...
    <main>
        ...
        <div class="container position-relative bg-white z-index-1">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <article class="card card-body mt-n10">
                        <h5>A sense of where you are</h5>
                        <article> This is based on an article published in the yearly report of <a href="https://enpact.org">enpact.org</a>. One of the greatest startup supporting organizations we partner with. </p>
                            <p>
                                Who does not feel dizzy when looking at all the events that have happened in 2020? It looked like the spinning top that is increasing its speed while an international rock band sings: “The world clearly has gone mad.”
                                Until 2020, we haven't seriously thought about the craziness of the world. We always thought that the world is a mad place. But 2020 puts everything into a new perspective. So we decided to look at the madness of the world more closely.
                            </p>
                            <p>
                                Social problems appear like moving targets. To solve these problems, old static ways don't work anymore. Most variables in the equations are not constant anymore. We realized that we have to find new dynamically adapting ways.
                                Let us take you on a short journey-of-thought of how we at CodeDoor have approached this context of accelerated changes of variables values.
                            </p>
                                Because the world seems to be unpredictable, you cannot apply conventional methods, right? We had to come up with new ways. As every good engineer does, we removed assumptions and conventions about how things have been done in the past. We stripped things down to their fundamentals and looked at what variables will most likely have the highest velocity in changing values.
                                To identify the variables we first asked, what questions should we ask. The following are some questions we tried to answer. If you want, don’t look at the answers, write your own answers down first, then look at our answers.
                                What did you come up with? We are happy to read yours.
                            <p>
                            <h4>
            ...
            <div class="container position-relative bg-white mt-4">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <article class="card card-body">
                        <h5>We have a new design</h5>
                        <p>Welcome to our new site! We are excited to announce that we have a new design.
                        Have fun exploring the page. We are looking forward to hearing your thoughts.</p>
                        <div class="border-top pt-4 mt-3">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="media align-items-center">
                                        <img class="avatar rounded-circle" src="static/img/cddr-logo.png" title="" alt="">
                                        <div class="media-body ps-3">
                                            <h6 class="mb-1">July 28th 2021, Your CodeDoor Team</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-4 my-3">
                        <div class="card shadow-sm-hover">
                            <img class="card-img-top" src="static/img/1000x700.jpg" title="" alt="">
                            <div class="card-body pt-0">
                                <div class="text-muted mb-4 mt-n3"><span class="bg-primary text-white py-1 px-3 d-inline-block rounded-pill small"><i class="far fa-clock me-2"></i>March 14, 2021</span></div>
                                <h5>I like the body. I like to design everything to do with the body.</h5>
                                <p class="pt-3 m-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                            </div>
                            <div class="card-footer d-flex align-items-center border-top">
                                <div class="media align-items-center">
                                    <div class="avatar avatar-sm overflow-hidden rounded-circle"> <img src="static/img/1000x1000.jpg" title="" alt=""> </div>
                                    <div class="media-body ps-3">
                                        <h6 class="m-0">Nancy Bayers</h6>
                                    </div>
                                </div>
                                <a href="#" class="stretched-link ms-auto icon icon-sm icon-primary rounded-circle"> <i class="fas fa-arrow-right"></i> </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 my-3">
