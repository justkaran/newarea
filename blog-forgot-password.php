    ...
    <section class="parallax effect-section" style="background-color:#0D4963">
        <div class="container position-relative">
            <div class="row min-vh-50 align-items-center justify-content-center pt-8 pb-12">
                <div class="col-lg-8">
                    <h1 class="display-5 text-white m-0 text-center">What to do if you forgot your password</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <article class="card card-body">
                    <h5>What to do if you forgot your password</h5>
                    <p>If you want to login to your CodeDoor dashboard and realise that you do not remember your password, please click "Forgot password": </p>
                    <img src="static/img/screenshots/forgot-password.png">
                    <br/>
                    <p>Please enter your email address and press "Request Reset".</p>
                    <img src="static/img/screenshots/PW-Reset.png">
                    <br/>
                    <p>You will then get an email from CodeDoor. Please press the "Reset password" button and follow the instructions.</p>
                    <br/>
                    <img src="static/img/screenshots/PW-Reset_Mail.png">
