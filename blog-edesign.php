    ...
    <section class="parallax effect-section" style="background-color:#0D4963">
        <div class="container position-relative">
            <div class="row min-vh-50 align-items-center justify-content-center pt-8 pb-12">
                <div class="col-lg-8">
                    <h1 class="display-5 text-white m-0 text-center">E-Design Handbuch</h1>
                    <ul class="nav mt-4 justify-content-center">
                        ...
                        <li class="h6 mx-2 text-white font-weight-normal"><i class="far fa-clock me-2"></i> Latest Entry: December 2, 2021</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <article class="card card-body">
                    <h5>European Union project E-Design</h5>
                    <p>Since 2019, CodeDoor has been working on the European Union project E-Design (European Digital Education for Social Inclusion and Global Neighbourhood). In an increasingly global and digital world, ICT skills are becoming more and more important and are required in many professions. The aim of the E-Design project was to promote social inclusion and to aquire or strengthen digital skills in order to combat social inequalities in disadvantaged groups.</p>
                    <p>It aimed to strengthen the structures of voluntary work in schools and communities to provide digital education free of charge and accessible to all. In addition to the acquisition of skills, there was also the opportunity to socialise in the community, which promotes social inclusion.</p>
                    <p>During the project, training hotspots were set up in Italy, Greece, Portugal and Germany. In these, courses were held on various topics such as 3D printing, programming or microcontrollers.</p>
                    <p>International exchange between the individual hotspots was always a priority. In addition to the courses, work was also done on learning videos, course materials and a platform for permanent exchange and learning.</p>
                    <p>From the respective courses and the associated experiences, a handbook was developed that is now freely available to all interested parties. It contains course contents, instructions for teachers and preparation materials.
                    </p>
                    <p><a href="static/E-DESIGN-Handbuch.zip" download="E-DESIGN-Handbuch.zip">Download Handbuch (DE)</a>
                    </p>


                    <img src="static/img/blog/edesign.jpg">
                    <br/>
                            ...
                            <div class="col-md-6">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ps-3">
                                        <h6 class="mb-1">December 2th 2021, Your CodeDoor Team</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
