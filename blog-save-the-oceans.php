    ...
    <section class="parallax effect-section" style="background-color:#0D4963">
        ...
        <div class="container position-relative">
            <div class="row min-vh-50 align-items-center justify-content-center pt-8 pb-12">
                <div class="col-lg-8">
                    <h1 class="display-5 text-white m-0 text-center">Save the Oceans!</h1>
                    <ul class="nav mt-4 justify-content-center">
                        ...
                        <li class="h6 mx-2 text-white font-weight-normal"><i class="far fa-clock me-2"></i> Latest Entry: August 4th 2021</li>
                    </ul>
                </div>
            </div>
        </div>
